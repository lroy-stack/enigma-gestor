...
export function MainLayout() {
  ...
  if (!user) {
    console.log('MainLayout - No user, showing login form');
    return <LoginForm />;
  }
  ...
  return (
    <div className="min-h-screen bg-ios-background">
      ...
      <div className={cn(
        ...
        "pb-6 lg:pb-8", // Reduced bottom padding on desktop (no bottom nav)
        isPersistentSidebar ? 
          (sidebarCollapsed ? "lg:ml-20" : "lg:ml-80") : ""
      )}>
        {/* Breadcrumbs */}
        <div className="px-4 sm:px-6 lg:px-8 py-4 bg-ios-background border-b border-enigma-neutral-200/50">
          <Breadcrumbs />
        </div>
